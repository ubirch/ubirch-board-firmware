...
/*!
 * @brief Prepare a HTTP request. Used by m66_http().
 ...
 * @param op the HTTP method (see ::m66_http_methods)
 * @param res_size the size of the response
 * @param timeout how long to wait for the connection
 * @return connection status
 */
int m66_http(m66_http_method_t op, size_t *res_size, uint32_t timeout);
